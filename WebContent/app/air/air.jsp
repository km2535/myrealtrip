			...
			<div id = "inttab">
				<ul class="section_1">
					<li class="interval_select">
						<input type="radio" id="initFormCodel" name="initform" onclick="javascript:airfn_clickinitFormCode_0100100010('RT', 'int');" checked="checked" value="RT" class="input_radio">
